...
-- 2. Función: genera notificaciones para un lote dado
...
-- 5. Policy para inserción por sistema
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Sistema inserta notificaciones' AND tablename = 'notificaciones'
  ) THEN
