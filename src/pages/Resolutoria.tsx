        ...
        <HeroImage imageUrl={RESOLUTORIA_IMG} height="480px" overlay="orange">
          <div className="mx-auto max-w-4xl px-4 text-center">
            ...
            <Button asChild size="xl" className="mt-8 bg-primary hover:bg-primary/90 text-primary-foreground">
              <Link to="/diagnostico">Solicitar mi Resultoría</Link>
            </Button>
          </div>
        </HeroImage>
        ...
        <section className="py-16 lg:py-20">
          <div className="mx-auto max-w-3xl px-4 text-center">
            ...
            <p className="mt-6 text-muted-foreground leading-relaxed">
              La Resultoría 360° es el proceso de viabilización más completo disponible en Colombia para lotes urbanos y rurales. Analizamos 8 áreas de conocimiento para darte una visión financiera real de tu predio.
            </p>
          </div>
        </section>
